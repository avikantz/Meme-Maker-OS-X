...
//}
//
//-(void)setDelegate:(id<DragDropImageViewDelegate>)delegate {
//}
//
//-(BOOL)allowDrop {
...
- (NSArray *)namesOfPromisedFilesDroppedAtDestination:(NSURL *)dropDestination
{
    ...
    [bitmapData writeToFile:[[dropDestination path] stringByAppendingPathComponent:@"meme.jpg"]  atomically:YES];
    return [NSArray arrayWithObjects:@"meme.jpg", nil];
}
